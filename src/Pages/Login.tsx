    ...
    return (
        ...
        >
            <form onSubmit={handleSubmit} className="space-y-8">
                ...
                <button
                    disabled={isLoading}
                    className="w-full h-16 bg-indigo-600 text-white rounded-xl font-black uppercase text-xs tracking-[0.4em] flex items-center justify-center gap-4 group active:scale-[0.98] transition-all disabled:opacity-50 shadow-2xl shadow-indigo-600/20"
                >
                    {isLoading ? (
                ...
                <div className="grid grid-cols-2 gap-4">
                    <button type="button" className="h-14 border border-slate-100 dark:border-slate-800 rounded-xl flex items-center justify-center gap-3 hover:bg-slate-50 dark:hover:bg-slate-950 transition-colors font-black text-[10px] uppercase tracking-widest text-slate-600 dark:text-slate-400">
